...
<head>
    ...
    <title>Borobudur Conservation Archives :: Memory of The World</title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?=base_url()?>" class="btn btn-info btn-rounded waves-effect waves-light mb-5">Back to home</a> </div>
            <footer class="footer text-center">2019 © Borobudur Conservation Archives.</footer>
        </div>
    </section>
    <!-- ============================================================== -->
    <!-- End Wrapper -->
