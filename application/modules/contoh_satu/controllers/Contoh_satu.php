...
class Contoh_satu extends Portal
{
    ...
    public function index()
    {
        ...
        // load select 2
        $this->load_js('assets/operator/plugins/bower_components/custom-select/custom-select.min.js');
        $this->load_css('assets/operator/plugins/bower_components/custom-select/custom-select.css');
