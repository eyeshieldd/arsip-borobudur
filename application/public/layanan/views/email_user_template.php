    ...
    <div style="padding: 40px; background: #fff;">
      <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
        <tbody>
          <tr>
            <td><b>Salam,</b>
              <p>Melalui email ini kami menginformasikan bahwa permohonan layanan Anda sudah kami terima dengan nomor layanan : <strong><?=$nomor_layanan?></strong> </p>
              <p>Berikut detail data yang Anda masukkan :</p>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            <td>
              <p>Anda dapat melakukan pengecekan proses permohonan melalui Whatsapp pada nomor <strong>0813-9291-1117</strong> dengan menginformasikan nomor layanan Anda</p>
